...
// With an arrow function, it uses the scope of whatever it's parent is. In ths case, that's the browser window object.

// 3. Explain why "this" is different when an arrow function is used.
// When joe.scope is invoked as a method of the constructor function, the 'this' is referring to its parent object. When the joe.scopeAarow is invoked, the arrow function doesn't have its own 'this'
